        ...
        <a href="index.php">
          ...
          <div class="social clear">
            <div class="icon clear">
              ...
              ?>
              <a href="https://www.facebook.com/MONITORUG/<?php echo $result['facebook']; ?>"><i class="fab fa-facebook-f"></i></a>
              <a href="https://www.instagram.com/monitorcso/<?php echo $result['instagram']; ?>"><i class="fab fa-instagram"></i></a>
              <a href="https://twitter.com/login?lang=en<?php echo $result['twitter']; ?>"><i class="fab fa-twitter"></i></a>
              <a href="https://www.linkedin.com/<?php echo $result['linkedin']; ?>"><i class="fab fa-linkedin-in"></i></a>
              <a href="https://www.google.com/chrome/<?php echo $result['google']; ?>"><i class="fab fa-google-plus-g"></i></a>
              <?php } } ?>
            </div>
